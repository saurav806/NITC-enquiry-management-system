...
//****************************1.1.1 about NITC ***********************************//
void aboutNitCALICUT(){
	system("cls");
	cout<<"\n\t\t\t\t*****NATIONAL INSTITUTE OF TECHNOLOGY CALICUT*****\n";
    cout<<"\t\t\t\t_____________________________________________________"<<endl<<endl;
    cout<<"\tNational Institute of Technology CALICUT (NIT CALICUT or NITCALICUT), is an Institute of National"<<endl;
    cout<<"\tImportance located at CALICUT, kerala, India. Established as a Regional Institute of Technology"<<endl;
...
void BoardOfGovt(){
	...
	cout<<"\t Director, National Institute of Technology CALICUT"<<endl<<endl;
...
void financeCommittee(){
	...
	cout<<"\tEmail: director@nitCALICUT.ac.in"<<endl<<endl;
	...
	cout<<"\tEmail:registrar@nitCALICUT.ac.in"<<endl<<endl;
...
void rankingAndRecognition(){
	...
	cout<<"\n\t\t\t\t*****NATIONAL INSTITUTE OF TECHNOLOGY CALICUT*****\n";
    cout<<"\t\t\t\t_____________________________________________________"<<endl<<endl;
	cout<<"\tInstitute Rank :AIR 31 (NIRF 2022)"<<endl<<endl;
...
//________________________________end_________________________________________//
    ...
    cout<<"\t\t\t\t_____________________________________________________"<<endl;
    cout<<endl<<endl;
    cout<<"\tNational Institute of Technology CALICUT popularly known as NIT CALICUT is conducting its placement"<<endl;
    ...
    cout<<endl<<endl;
    cout<<"\t-> Team Revanta"<<endl<<"\t-> nss ,nit CALICUT"<<endl<<"\t-> Phocus "<<endl<<"\t-> Team phonix "<<endl;
	...
	cout<<"\tAnd if you l like going out you can always visit the beautiful city of CALICUT. Some of the major tourist attractions of the"<<endl;
	cout<<"\tcity are Jubilee park which was a gift by Tata Steel to the citizens of CALICUT on the completion of its 50 years."<<endl;
	...
	void Life_at_nitCALICUT(){
		system("cls");
	cout<<"\n\t\t\t\t*****NATIONAL INSTITUTE OF TECHNOLOGY CALICUT*****\n";
    cout<<"\t\t\t\t_____________________________________________________"<<endl;
    cout<<endl<<"________________Life at nitCALICUT _______________"<<endl;
    cout<<endl<<endl;
    cout<<"    Detail of life at nitCALICUT is here: "<<endl<<endl<<endl;
    do{
        cout<<endl<<endl<<"\t1.Go to Back "<<endl;
        cout<<"\t2.Go to main menu"<<endl;
        cout<<"\t3.Exit"<<endl;
...
void complaint::student(){
	...
	if(userName == "CALICUTstudent" && pass == 123){
...
void complaint::createComplaint(){
	...
	system("cls");
	cout<<"\t\t==========================================\n";
	cout<<"\t\t|	NIT CALICUT Complaint Portal	 |\n";
	cout<<"\t\t==========================================\n\n";
...
//	fout<<"\t\t==========================================\n";
//	fout<<"\t\t|	NIT CALICUT Complaint Portal	 |\n";
//	fout<<"\t\t==========================================\n\n";
...
system("cls");
    ...
    cout<<" 4.NOTICE-125-2022 Workshop on Recent Advances in Modelling of Materials- Part 2 at NIT CALICUT."<<endl<<endl;
